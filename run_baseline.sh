...
# python main.py  -c config/config_baseline.yaml  -m FM  -r FM_baseline
python main.py  -c config/config_baseline.yaml  -m FFM  -r FFM_baseline
python main.py  -c config/config_baseline.yaml  -m CatBoost # wandb 저장 안됨
python main.py  -c config/config_baseline.yaml  -m DeepFM  -r DeepFM_baseline
python main.py  -c config/config_baseline.yaml  -m WDN  -r WDN_baseline
python main.py  -c config/config_baseline.yaml  -m DCN  -r DCN_baseline
python main.py  -c config/config_baseline.yaml  -m NCF  -r NCF_baseline
