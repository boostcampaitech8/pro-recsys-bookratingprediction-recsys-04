...
def catboost_data_load(args):
    ...
    user_base_path = "/data/ephemeral/home/data/features/v1/"


    # Load data
    users = pd.read_parquet(user_base_path + "users/users_features.parquet")
    ...
    numeric_features = ["year_of_publication_clipped", "age_of_book"]
